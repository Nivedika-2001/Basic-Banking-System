...
<div class="container contact-form">
            <div class="contact-image">
                <img src="img/contact_us_image.png" alt="contact_us logo">  
            </div>
            <form method="post">
               ...
               <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <textarea name="txtMsg" class="form-control" placeholder="Type Here*" style="width: 100%; height: 150px;"></textarea>
                        </div>
                    </div>
                </div>
            </form>
